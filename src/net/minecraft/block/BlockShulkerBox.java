...
public class BlockShulkerBox extends BlockContainer
{
    ...
    public void func_190948_a(ItemStack p_190948_1_, World p_190948_2_, List<String> p_190948_3_, ITooltipFlag p_190948_4_)
    {
        ...
        if (nbttagcompound != null && nbttagcompound.hasKey("BlockEntityTag", 10))
        {
            ...
            {
                NonNullList<ItemStack> nonnulllist = NonNullList.<ItemStack>func_191197_a(27, ItemStack.EMPTY);
