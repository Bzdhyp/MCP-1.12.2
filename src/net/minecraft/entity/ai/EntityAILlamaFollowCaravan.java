...
public class EntityAILlamaFollowCaravan extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        if (!this.field_190859_a.getLeashed() && !this.field_190859_a.func_190718_dR())
        {
            ...
            for (EntityLlama entityllama1 : list)
            {
                ...
                {
                    double d1 = this.field_190859_a.getDistanceSq(entityllama1);
            ...
            if (entityllama == null)
            {
                for (EntityLlama entityllama2 : list)
                {
                    ...
                    {
                        double d2 = this.field_190859_a.getDistanceSq(entityllama2);
    ...
    public boolean continueExecuting()
    {
        ...
        {
            double d0 = this.field_190859_a.getDistanceSq(this.field_190859_a.func_190716_dS());
