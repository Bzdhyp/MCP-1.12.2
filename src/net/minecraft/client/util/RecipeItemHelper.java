...
public class RecipeItemHelper
{
    ...
    public boolean func_194116_a(IRecipe p_194116_1_, IntList p_194116_2_)
    {
        return this.func_194118_a(p_194116_1_, p_194116_2_, 1);
    }

    public boolean func_194118_a(IRecipe p_194118_1_, IntList p_194118_2_, int p_194118_3_)
    {
        return (new RecipeItemHelper.RecipePicker(p_194118_1_)).func_194092_a(p_194118_3_, p_194118_2_);
    }

    public int func_194114_b(IRecipe p_194114_1_, IntList p_194114_2_)
    {
        return this.func_194121_a(p_194114_1_, Integer.MAX_VALUE, p_194114_2_);
    }

    public int func_194121_a(IRecipe p_194121_1_, int p_194121_2_, IntList p_194121_3_)
    {
    ...
    class RecipePicker
    {
        ...
        public boolean func_194092_a(int p_194092_1_, IntList p_194092_2_)
        {
            if (p_194092_1_ <= 0)
            {
                return true;
        ...
        public int func_194102_b(int p_194102_1_, IntList p_194102_2_)
        {
            int k = 0;
