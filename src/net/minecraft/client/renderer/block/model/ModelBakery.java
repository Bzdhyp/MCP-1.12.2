...
public class ModelBakery {
    ...
    protected void loadBlock(BlockStateMapper p_loadBlock_1_, Block p_loadBlock_2_,
        ...
        if (modelblockdefinition.hasMultipartData()) {
            ...
            Collection<ModelResourceLocation> collection1 = this.multipartVariantMap
    ...
    private List<String> getVariantNames(Item stack) {
        ...
        if (list == null) {
            list = Collections
                    .singletonList(Item.REGISTRY.getNameForObject(stack).toString());
        }
    ...
    private void bakeBlockModels() {
        ...
        for (Entry<ModelBlockDefinition, Collection<ModelResourceLocation>> entry : this.multipartVariantMap
            ...
            String s = Block.REGISTRY.getNameForObject(multipart.getStateContainer().getBlock())
                    .toString();
