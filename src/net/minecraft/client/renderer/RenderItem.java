...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void func_191970_a(BufferBuilder p_191970_1_, List<BakedQuad> p_191970_2_, int p_191970_3_, ItemStack p_191970_4_)
    {
        ...
        for (int j = p_191970_2_.size(); i < j; ++i)
        {
            ...
            this.renderQuad(p_191970_1_, bakedquad, k);
        }
    }
    ...
    private void registerItems() {
        ...
        this.registerBlock(Blocks.field_1924BLUE_GLAZED_TERRACOTTA8_dM, "blue_glazed_terracotta");
        ...
        for (EnumDyeColor enumdyecolor : EnumDyeColor.values()) {
            ...
            this.registerBlock(Blocks.CONCRETE_POWDER, enumdyecolor.getMetadata(), enumdyecolor.func_192396_c() + "_concrete_powder");
        }
