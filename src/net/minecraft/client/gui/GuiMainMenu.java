...
public class GuiMainMenu extends GuiScreen {
    ...
    public void initGui()
    {
        ...
        this.widthCopyright = this.fontRendererObj.getStringWidth("Copyright Mojang AB. Do not distribute!");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawString(this.fontRendererObj, "Copyright Mojang AB. Do not distribute!", this.widthCopyrightRest, this.height - 10, -1);
        ...
        if (this.openGLWarning1 != null && !this.openGLWarning1.isEmpty()) {
            ...
            this.drawString(this.fontRendererObj, this.openGLWarning2, (this.width - this.openGLWarning2Width) / 2, (this.buttonList.get(0)).y - 12, -1);
        }
