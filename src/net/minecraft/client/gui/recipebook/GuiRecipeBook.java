...
public class GuiRecipeBook extends Gui implements IRecipeUpdateListener
{
    ...
    public void func_191874_a(Slot p_191874_1_)
    {
    ...
    private void func_193015_d(int p_193015_1_, int p_193015_2_, int p_193015_3_, int p_193015_4_)
    {
        ...
        {
            this.field_191888_F.currentScreen.drawHoveringText(this.field_191888_F.currentScreen.getItemToolTip(itemstack), p_193015_3_, p_193015_4_);
        }
    }
