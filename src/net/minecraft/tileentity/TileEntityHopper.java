...
{
    private NonNullList<ItemStack> inventory = NonNullList.<ItemStack>func_191197_a(5, ItemStack.EMPTY);
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        this.inventory = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(), ItemStack.EMPTY);
     ...
     */
    public static ItemStack putStackInInventoryAllSlots(IInventory inventoryIn, IInventory stack, ItemStack side, EnumFacing p_174918_3_)
    {
