...
public class TileEntityBrewingStand extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    private NonNullList<ItemStack> brewingItemStacks = NonNullList.<ItemStack>func_191197_a(5, ItemStack.EMPTY);
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        this.brewingItemStacks = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(), ItemStack.EMPTY);
