...
public class CrashReport {
    ...
    private void populateEnvironment() {
        this.systemDetailsCategory.setDetail("Minecraft Version", () -> "1.12.2");
        this.systemDetailsCategory.setDetail("Operating System", () -> System.getProperty("os.name") + " (" + System.getProperty("os.arch") + ") version " + System.getProperty("os.version"));
        this.systemDetailsCategory.setDetail("Java Version", () -> System.getProperty("java.version") + ", " + System.getProperty("java.vendor"));
        this.systemDetailsCategory.setDetail("Java VM Version", () -> System.getProperty("java.vm.name") + " (" + System.getProperty("java.vm.info") + "), " + System.getProperty("java.vm.vendor"));
        this.systemDetailsCategory.setDetail("Memory", () -> {
        ...
        this.systemDetailsCategory.setDetail("JVM Flags", () -> {
        ...
        this.systemDetailsCategory.setDetail("IntCache", IntCache::getCacheSizes);
    }
