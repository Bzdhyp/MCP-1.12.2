...
public class ShapedRecipes implements IRecipe
{
    ...
    {
        NonNullList<ItemStack> nonnulllist = NonNullList.<ItemStack>func_191197_a(inv.getSizeInventory(), ItemStack.EMPTY);
    ...
    public static Ingredient func_193361_a(JsonElement p_193361_0_)
    {
