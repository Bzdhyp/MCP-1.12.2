...
public class FurnaceRecipes
{
    ...
    private FurnaceRecipes()
    {
        ...
        this.addSmeltingRecipe(new ItemStack(Blocks.STAINED_HARDENED_CLAY, 1, EnumDyeColor.BLUE.getMetadata()), new ItemStack(Blocks.field_1924BLUE_GLAZED_TERRACOTTA8_dM), 0.1F);
